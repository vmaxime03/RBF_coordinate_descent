...
hSamplesPts = plot3(samples(:, 1), samples(:, 2), zeros(nsamples,1) + zfloor, 'ko', 'MarkerSize', 2, 'MarkerFaceColor', 'magenta');
hSamplesNormals = quiver3(samples(:, 1), samples(:, 2), zeros(nsamples,1) + zfloor, samples(:, 3), samples(:, 4), zeros(nsamples, 1), 0.2, 'k', 'LineWidth', 1);
